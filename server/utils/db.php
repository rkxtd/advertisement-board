...
class Db {
	 ...
	 */
	private function __construct ( $driver, $host, $database, $user, $password = null ) {
    ...
    static public function getInstance($driver = null, $host = null, $database = null, $user = null, $password = null) {
        if(is_null(self::$instance))
        {
            self::$instance = new self($driver, $host, $database, $user, $password);
        }
